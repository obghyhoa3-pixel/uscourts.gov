...
! function(e) {
    ...
    return e.extend(e.expr.pseudos, {
        data: e.expr.createPseudo((function(n) {
            return function(t) {
                return !!e.data(t, n)
            }
        }))
...
! function(e) {
    ...
    "use strict";
    e.escapeSelector || (e.escapeSelector = function(e) {
        return CSS.escape(e + "")
...
! function(e) {
    ...
    return e.ui.focusable = function(t, i) {
        var s, n, u, a, o, r = t.nodeName.toLowerCase();
        return "area" === r ? (n = (s = t.parentNode).name, !(!t.href || !n || "map" !== s.nodeName.toLowerCase()) && ((u = e("img[usemap='#" + n + "']")).length > 0 && u.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(r) ? (a = !t.disabled) && (o = e(t).closest("fieldset")[0]) && (a = !o.disabled) : a = "a" === r && t.href || i, a && e(t).is(":visible") && "visible" === e(t).css("visibility"))
...
! function(t) {
    ...
    return t.fn.labels = function() {
        var t, s, e, i, n;
        return this.length ? this[0].labels && this[0].labels.length ? this.pushStack(this[0].labels) : (i = this.eq(0).parents("label"), (e = this.attr("id")) && (n = (t = this.eq(0).parents().last()).add(t.length ? t.siblings() : this.siblings()), s = "label[for='" + CSS.escape(e) + "']", i = i.add(n.find(s).addBack(s))), this.pushStack(i)) : this.pushStack([])
    }
}));
...
! function(e) {
    ...
    return e.ui.formResetMixin = {
        ...
        _bindFormResetHandler: function() {
            if (this.form = e(this.element.prop("form")), this.form.length) {
    ...
    return e(document).on("mouseup", (function() {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, (function(e) {
                ...
                if (!0 === e.data(s.target, t.widgetName + ".preventClickEvent")) return e.removeData(s.target, t.widgetName + ".preventClickEvent"), s.stopImmediatePropagation(), !1
            })), this.started = !1
        },
        ...
        _mouseDown: function(s) {
            if (!t) {
                ...
                var i = this,
                    o = 1 === s.which,
                    n = "string" == typeof this.options.cancel && e(s.target).closest(this.options.cancel).length;
                return !(o && !n && this._mouseCapture(s)) || (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout((function() {
                    i.mouseDelayMet = !0
                }), this.options.delay)), this._mouseDistanceMet(s) && this._mouseDelayMet(s) && (this._mouseStarted = !1 !== this._mouseStart(s), !this._mouseStarted) ? (s.preventDefault(), !0) : (!0 === e.data(s.target, this.widgetName + ".preventClickEvent") && e.removeData(s.target, this.widgetName + ".preventClickEvent"), this._mouseMoveDelegate = function(e) {
                    return i._mouseMove(e)
                }, this._mouseUpDelegate = function(e) {
                    return i._mouseUp(e)
                }, this.document.on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate), s.preventDefault(), t = !0, !0))
            }
        },
        ...
        _mouseUp: function(s) {
            this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, s.target === this._mouseDownEvent.target && e.data(s.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(s)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, t = !1, s.preventDefault()
        },
...
! function(e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["jquery", "./menu", "../keycode", "../position", "../version", "../widget"], e) : e(jQuery)
}((function(e) {
    "use strict";
    return e.widget("ui.autocomplete", {
        ...
        _create: function() {
            var t, i, s, n = this.element[0].nodeName.toLowerCase(),
                o = "textarea" === n,
                u = "input" === n;
            this.isMultiLine = o || !u && "true" === this.element.prop("contentEditable"), this.valueMethod = this.element[o || u ? "val" : "text"], this.isNewMenu = !0, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "off"), this._on(this.element, {
                keydown: function(n) {
                ...
                menuselect: function(e, t) {
                    var i = t.item.data("ui-autocomplete-item"),
                        s = this.previous;
                    this.element[0] !== this.document[0].activeElement && (this.element.trigger("focus"), this.previous = s), !1 !== this._trigger("select", e, {
                        item: i
        ...
        _create: function() {
            this.activeMenu = this.element, this.mouseHandled = !1, this.lastMousePosition = {
                ...
                "click .ui-menu-item": function(t) {
                    var i = e(t.target),
                        s = e(this.document[0].activeElement);
...
! function(t) {
    "use strict";
    "function" == typeof define && define.amd ? define(["jquery", "./mouse", "../data", "../plugin", "../scroll-parent", "../version", "../widget"], t) : t(jQuery)
}((function(t) {
    "use strict";
    return t.widget("ui.draggable", t.ui.mouse, {
        ...
        _blurActiveElement: function(e) {
            var s = this.document[0].activeElement;
            t(e.target).closest(s).length || t(s).trigger("blur")
        },
...
! function(t) {
    ...
    return t.widget("ui.resizable", t.ui.mouse, {
        ...
        _create: function() {
            ...
            }, this.element.css(e), this.originalResizeStyle = this.originalElement.css("resize"), this.originalElement.css("resize", "none"), this._proportionallyResizeElements.push(this.originalElement.css({
                position: "static",
                zoom: 1,
                display: "block"
            })), this._proportionallyResize()), this._setupHandles(), i.autoHide && t(this.element).on("mouseenter", (function() {
        ...
        _setupHandles: function() {
            ...
            if (this.handles = o.handles || (t(".ui-resizable-handle", this.element).length ? {
                ...
                for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), s = this.handles.split(","), this.handles = {}, i = 0; i < s.length; i++) h = "ui-resizable-" + (e = String.prototype.trim.call(s[i])), n = t("<div>"), this._addClass(n, "ui-resizable-handle " + h), n.css({
                    zIndex: o.zIndex
                }), this.handles[e] = ".ui-resizable-" + e, this.element.children(this.handles[e]).length || (this.element.append(n), this._addedHandles = this._addedHandles.add(n));
            this._renderAxis = function(e) {
                ...
                })), this.elementIsWrapper && this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i) && (s = t(this.handles[i], this.element), n = /sw|ne|nw|se|n|s/.test(i) ? s.outerHeight() : s.outerWidth(), h = ["padding", /ne|nw|n/.test(i) ? "Top" : /se|sw|s/.test(i) ? "Bottom" : /^e$/.test(i) ? "Right" : "Left"].join(""), e.css(h, n), this._proportionallyResize()), this._handles = this._handles.add(this.handles[i])
        ...
        _mouseCapture: function(e) {
            var i, s, h = !1;
            for (i in this.handles)((s = t(this.handles[i])[0]) === e.target || t.contains(s, e.target)) && (h = !0);
            return !this.options.disabled && h
        },
        _mouseStart: function(e) {
            var i, s, h, n, o = this.options,
                a = this.element;
            return this.resizing = !0, this._renderProxy(), i = this._num(this.helper.css("left")), s = this._num(this.helper.css("top")), o.containment && (i += t(o.containment).scrollLeft() || 0, s += t(o.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                left: i,
                top: s
            }, this._helper || (n = this._calculateAdjustedElementDimensions(a)), this.size = this._helper ? {
                ...
                left: e.pageX,
                top: e.pageY
            }, this.aspectRatio = "number" == typeof o.aspectRatio ? o.aspectRatio : this.originalSize.width / this.originalSize.height || 1, h = t(".ui-resizable-" + this.axis).css("cursor"), t("body").css("cursor", "auto" === h ? this.axis + "-resize" : h), this._addClass("ui-resizable-resizing"), this._propagate("start", e), !0
        },
        _mouseDrag: function(e) {
            var i, s, h = this.originalMousePosition,
                n = this.axis,
                o = e.pageX - h.left || 0,
                a = e.pageY - h.top || 0,
                l = this._change[n];
        ...
        _mouseStop: function(e) {
            this.resizing = !1;
            var i, s, h, n, o, a, l, r = this.options,
                p = this;
            return this._helper && (h = (s = (i = this._proportionallyResizeElements).length && /textarea/i.test(i[0].nodeName)) && this._hasScroll(i[0], "left") ? 0 : p.sizeDiff.height, n = s ? 0 : p.sizeDiff.width, o = {
                ...
                top: l,
                left: a
            })), p.helper.height(p.size.height), p.helper.width(p.size.width), this._helper && !r.animate && this._proportionallyResize()), t("body").css("cursor", "auto"), this._removeClass("ui-resizable-resizing"), this._propagate("stop", e), this._helper && this.helper.remove(), !1
        },
        ...
        _respectSize: function(t) {
            var e = this._vBoundaries,
                ...
                r = /sw|nw|w/.test(i),
                p = /nw|ne|n/.test(i);
            return n && (t.width = e.minWidth), o && (t.height = e.minHeight), s && (t.width = e.maxWidth), h && (t.height = e.maxHeight), n && r && (t.left = a - e.minWidth), s && r && (t.left = a - e.maxWidth), o && p && (t.top = l - e.minHeight), h && p && (t.top = l - e.maxHeight), t.width || t.height || t.left || !t.top ? t.width || t.height || t.top || !t.left || (t.left = null) : t.top = null, t
        },
        _getPaddingPlusBorderDimensions: function(t) {
            for (var e = 0, i = [], s = [t.css("borderTopWidth"), t.css("borderRightWidth"), t.css("borderBottomWidth"), t.css("borderLeftWidth")], h = [t.css("paddingTop"), t.css("paddingRight"), t.css("paddingBottom"), t.css("paddingLeft")]; e < 4; e++) i[e] = parseFloat(s[e]) || 0, i[e] += parseFloat(h[e]) || 0;
            return {
                height: i[0] + i[2],
                width: i[1] + i[3]
            }
        ...
        _calculateAdjustedElementDimensions: function(t) {
            var e, i, s, h = t.get(0);
            return "content-box" !== t.css("box-sizing") || !this._hasScroll(h) && !this._hasScroll(h, "left") ? {
                height: parseFloat(t.css("height")),
                width: parseFloat(t.css("width"))
            } : (e = parseFloat(h.style.width), i = parseFloat(h.style.height), s = this._getPaddingPlusBorderDimensions(t), e = isNaN(e) ? this._getElementTheoreticalSize(t, s, "width") : e, {
        ...
        stop: function(e) {
            var i = t(this).resizable("instance"),
                ...
                p = parseFloat(i.element.css("top")) + (i.position.top - i.originalPosition.top) || null;
            i.element.animate(t.extend(l, p && r ? {
                top: p,
                left: r
            } : {}), {
        ...
        start: function() {
            var e, i, s, h, n, o, a, l = t(this).resizable("instance"),
                r = l.options,
                p = l.element,
                d = r.containment,
            ...
            }) : (e = t(g), i = [], t(["Top", "Right", "Left", "Bottom"]).each((function(t, s) {
        ...
        resize: function(e) {
            var i, s, h, n, o = t(this).resizable("instance"),
                a = o.options,
                l = o.containerOffset,
                r = o.position,
        ...
        start: function() {
            ...
            e.ghost = e.originalElement.clone(), e.ghost.css({
                ...
                left: 0,
                top: 0
            }), e._addClass(e.ghost, "ui-resizable-ghost"), !0 === t.uiBackCompat && "string" == typeof e.options.ghost && e.ghost.addClass(this.options.ghost), e.ghost.appendTo(e.helper)
        },
        resize: function() {
            var e = t(this).resizable("instance");
            e.ghost && e.ghost.css({
        ...
        resize: function() {
            var e, i = t(this).resizable("instance"),
                ...
                _ = s.minHeight && s.minHeight > c;
            s.grid = l, z && (u += r), _ && (c += p), f && (u -= r), m && (c -= p), /^(se|s|e)$/.test(a) ? (i.size.width = u, i.size.height = c) : /^(ne)$/.test(a) ? (i.size.width = u, i.size.height = c, i.position.top = o.top - g) : /^(sw)$/.test(a) ? (i.size.width = u, i.size.height = c, i.position.left = o.left - d) : ((c - p <= 0 || u - r <= 0) && (e = i._getPaddingPlusBorderDimensions(this)), c - p > 0 ? (i.size.height = c, i.position.top = o.top - g) : (c = p - e.height, i.size.height = c, i.position.top = o.top + n.height - c), u - r > 0 ? (i.size.width = u, i.position.left = o.left - d) : (u = r - e.width, i.size.width = u, i.position.left = o.left + n.width - u))
        }
    }), t.ui.resizable
}));
...
! function(t) {
    ...
    }), !0 === t.uiBackCompat && (t.widget("ui.button", t.ui.button, {
        options: {
            text: !0,
            icons: {
                primary: null,
...
! function(i) {
    "use strict";
    "function" == typeof define && define.amd ? define(["jquery", "./button", "./draggable", "./mouse", "./resizable", "../focusable", "../keycode", "../position", "../tabbable", "../unique-id", "../version", "../widget"], i) : i(jQuery)
}((function(i) {
    "use strict";
    return i.widget("ui.dialog", {
        ...
        close: function(t) {
            var e = this;
            this._isOpen && !1 !== this._trigger("beforeClose", t) && (this._isOpen = !1, this._focusedElement = null, this._destroyOverlay(), this._untrackInstance(), this.opener.filter(":focusable").trigger("focus").length || i(this.document[0].activeElement).trigger("blur"), this._hide(this.uiDialog, this.options.hide, (function() {
                e._trigger("close", t)
            })))
        },
        isOpen: function() {
        ...
        open: function() {
            var t = this;
            this._isOpen ? this._moveToTop() && this._focusTabbable() : (this._isOpen = !0, this.opener = i(this.document[0].activeElement), this._size(), this._position(), this._createOverlay(), this._moveToTop(null, !0), this.overlay && this.overlay.css("z-index", this.uiDialog.css("z-index") - 1), this._show(this.uiDialog, this.options.show, (function() {
        ...
        _keepFocus: function(i) {
            i.preventDefault(), this._restoreTabbableFocus()
        },
        ...
        _createTitlebar: function() {
            ...
            var e = Number.isInteger(this.options.uiDialogTitleHeadingLevel) && this.options.uiDialogTitleHeadingLevel > 0 && this.options.uiDialogTitleHeadingLevel <= 6 ? "h" + this.options.uiDialogTitleHeadingLevel : "span";
            t = i("<" + e + ">").uniqueId().prependTo(this.uiDialogTitlebar), this._addClass(t, "ui-dialog-title"), this._title(t), this.uiDialogTitlebar.prependTo(this.uiDialog), this.uiDialog.attr({
        ...
        _setOption: function(t, e) {
            ...
            "disabled" !== t && (this._super(t, e), "appendTo" === t && this.uiDialog.appendTo(this._appendTo()), "buttons" === t && this._createButtons(), "closeText" === t && this.uiDialogTitlebarClose.button({
                label: i("<a>").text("" + this.options.closeText).html()
            }), "draggable" === t && ((o = n.is(":data(ui-draggable)")) && !e && n.draggable("destroy"), !o && e && this._makeDraggable()), "position" === t && this._position(), "resizable" === t && ((s = n.is(":data(ui-resizable)")) && !e && n.resizable("destroy"), s && "string" == typeof e && n.resizable("option", "handles", e), s || !1 === e || this._makeResizable()), "title" === t && this._title(this.uiDialogTitlebar.find(".ui-dialog-title")), "modal" === t && n.attr("aria-modal", e ? "true" : null))
        },
        _size: function() {
        ...
        _createOverlay: function() {
            if (this.options.modal) {
                ...
                this._delay((function() {
                    ...
                    if (!t) {
                        var e = this._trackingInstances()[0];
                        e._allowInteraction(i) || (i.preventDefault(), e._focusTabbable())
                    }
    ...
    }), !0 === i.uiBackCompat && i.widget("ui.dialog", i.ui.dialog, {
        options: {
            dialogClass: ""
        },
        _createWrapper: function() {
...
! function(e, t) {
    ...
    function r(e) {
        if (t()) return c;
        if (!(null == e ? void 0 : e.useGlobalLockState)) return r.lockState;
        var n = "__BSL_LOCK_STATE__" in window ? Object.assign(Object.assign({}, c), window.__BSL_LOCK_STATE__) : c;
        return window.__BSL_LOCK_STATE__ = n, n
    }

    function d(e) {
        return !n().ios && ("function" == typeof e.unLockCallback && (e.unLockCallback(), !0))
    }

    function s(e) {
        e.documentListenerAdded && (document.removeEventListener("touchmove", i(), o({
            passive: !1
        })), e.documentListenerAdded = !1)
    }
    r.lockState = c, e.clearBodyLocks = function(e) {
        if (!t()) {
            var n = r(e);
            if (n.lockedNum = 0, !d(n)) {
                if (n.lockedElements.length)
                    for (var o = n.lockedElements.pop(); o;) o.ontouchmove = null, o.ontouchstart = null, o = n.lockedElements.pop();
                s(n)
            }
        }
    }, e.getLockState = r, e.lock = function(e, c) {
        if (!t()) {
            var d, s, u, a, f = n(),
                h = r(c);
            f.ios ? (l(e).filter((function(e) {
                return e && -1 === h.lockedElements.indexOf(e)
            })).forEach((function(e) {
                e.ontouchstart = function(e) {
                    ...
                    ! function(e, t, n) {
                        if (t) {
                            ...
                            if (f && (a > 0 && 0 === o || a < 0 && o + s + 1 >= r) || !f && (u > 0 && 0 === l || u < 0 && l + d + 1 >= c)) return i()(e)
                        }
                        e.stopPropagation()
                    }(t, e, h.initialClientPos)
                }, h.lockedElements.push(e)
            })), function(e) {
                if (!n().ios) return;
                if (e.documentListenerAdded) return;
                document.addEventListener("touchmove", i(), o({
                    passive: !1
                })), e.documentListenerAdded = !0
            }(h)) : h.lockedNum <= 0 && (h.unLockCallback = f.android ? function(e) {
            ...
            }(c) : (d = document.documentElement, s = Object.assign({}, d.style), u = window.innerWidth - d.clientWidth, a = parseInt(window.getComputedStyle(d).paddingRight, 10), d.style.overflow = "hidden", d.style.boxSizing = "border-box", d.style.paddingRight = "".concat(u + a, "px"), function() {
                ["overflow", "boxSizing", "paddingRight"].forEach((function(e) {
                    d.style[e] = s[e] || ""
                }))
            })), h.lockedNum += 1
        }
    }, e.unlock = function(e, n) {
        if (!t()) {
            var o = r(n);
            o.lockedNum -= 1, o.lockedNum > 0 || d(o) || (l(e).forEach((function(e) {
                var t = o.lockedElements.indexOf(e);
                e && -1 !== t && (e.ontouchmove = null, e.ontouchstart = null, o.lockedElements.splice(t, 1))
            })), s(o))
        }
    }
}));;
(function($, Drupal) {
    ...
    function searchHandler(event) {
        ...
        if (term.length > 0 && options.firstCharacterBlacklist.includes(term[0])) return false;
    ...
    function sourceData(request, response) {
        ...
        function showSuggestions(suggestions) {
            ...
            for (let i = 0; i < il; i++)
                if (suggestions.includes(tagged[i])) suggestions.splice(suggestions.indexOf(tagged[i]), 1);
        ...
        if (autocomplete.cache[elementId].hasOwnProperty(term)) showSuggestions(autocomplete.cache[elementId][term]);
        else {
    ...
    Drupal.behaviors.autocomplete = {
        attach(context) {
            once('autocomplete', 'input.form-autocomplete', context).forEach((element) => {
        ...
        for (let n = 0; n < positionOptions.length; n++) {
            ...
            if (optionValue)
                if (typeof optionValue === 'string' && optionValue.endsWith('%') && /height/i.test(option)) {
                    ...
                    if (option === 'height' && Math.round(event.data.$element.parent().outerHeight()) < adjustedValue) adjustedValue = 'auto';
...
((Drupal, drupalSettings, once, $) => {
    ...
    function handleKeyup(e) {
            ...
            case 'Enter':
                {
                    ...
                    if ($selectableItems.length === 1) {
                        const $isTheNoResultsOption = $selectableItems.filter(function() {
                            return $(this).find('a div div').text().trim() !== drupalSettings ? .search_autocomplete ? .usc_court_finder_search_homepage.noResult.label;
                        }).find('a');
                        if ($isTheNoResultsOption.length === 0) {
                            e.preventDefault();
                            return false;
                        }
                    }
        ...
        if (direction === 'up')
            if ($currentItem.length)
                if ($currentItem.is($selectableItems.first())) $newSelection = $selectableItems.last();
                else {
        ...
        else $newSelection = $selectableItems.last();
        if (direction === 'down')
            if ($currentItem.length)
                if ($currentItem.is($selectableItems.last())) $newSelection = $selectableItems.first();
                else {
                    const positionInSelectableItems = getKeyByValue($selectableItems, $currentItem[0]);
                    $newSelection = $($selectableItems[positionInSelectableItems + 1]);
                }
        else $newSelection = $selectableItems.first();
    ...
    $('#court-finder-by-name').parents('form').on('submit', (e) => {
        const inputValue = $('#court-finder-by-name').val().trim();
...
((Drupal, once) => {
    ...
    function init(header) {
        ...
        document.addEventListener('keyup', (e) => {
            if (e.key === 'Escape') changeSearchVisibility(false);
            if (e.key === 'Enter' && keysSearch.value.length <= 3) e.preventDefault();
        });
    ...
    function handleKeywordsChange() {
        ...
        if (keys.length < 3) submitSearch.setAttribute('disabled', 'disabled');
        else submitSearch.removeAttribute('disabled');
    }

    function handleSearchFocusOut(e) {
        if (!Drupal.uscgov.isMobileMenuSystem())
            if (!searchWrapper.contains(e.relatedTarget) && e.relatedTarget !== desktopSearchButton) setTimeout(() => changeSearchVisibility(false), 200);
    }
    ...
    function changeSearchVisibility(toState) {
        ...
        if (toState === false && !Drupal.uscgov.isMobileMenuSystem() && searchWrapperContainsFocus) desktopSearchButton.focus();
        if (toState === true && !Drupal.uscgov.isMobileMenuSystem()) searchWrapper.querySelector('input[type="text"]') ? .focus();
    }
...
((Drupal) => {
    ...
    Drupal.uscgov.toggleFocusTrap = (focusTrapEnabled) => {
        ...
        if (Drupal.uscgov.isMobileMenuSystem() && focusTrapEnabled === true) document.querySelectorAll(Drupal.uscgov.focusableElementsSelector).forEach((focusableElement) => {
            if (!menuWrapper.contains(focusableElement)) {
                focusableElement.inert = true;
                focusableElement.dataset.mobileMenuInert = true;
            }
        });
        else document.querySelectorAll('[data-mobile-menu-inert], [data-mobile-menu-submenu-inert]').forEach((el) => {
            el.inert = false;
    ...
    function modifyHeaderOnScroll(scrollPos) {
        if (scrollPos > 100) header.classList.add('is-slim');
        else {
            if (scrollPos < 20) header.classList.remove('is-slim');
        }
    }
    ...
    if (header) document.addEventListener('scroll', handlePageScroll);
...
((Drupal, once) => {
    ...
    function init(header) {
        ...
        document.addEventListener('keyup', (e) => {
            if (e.key === 'Escape') changeMenuVisibility(false);
        });
    ...
    function changeMenuVisibility(toState) {
        ...
        if (toState === false && Drupal.uscgov.isMobileMenuSystem()) Drupal.uscgov.closeAllMenuItems();
        if (Drupal.uscgov.isMobileMenuSystem())
            if (toState) menuWrapper.addEventListener('transitionend', () => {
                menuWrapper.querySelector(Drupal.uscgov.focusableElementsSelector) ? .focus();
            }, {
                once: true
            });
            else {
                if (menuWrapperContainsFocus) mobileNavButton.focus();
            }
    }
...
((Drupal, once) => {
    function init(menu) {
        ...
        menuButtons.forEach((menuButton) => {
            menuButton.addEventListener('click', () => {
                if (Drupal.uscgov.isMobileMenuSystem()) expandMenu(menuButton);
            });
        });
        ...
        `;
            ...
            backButton.addEventListener('click', () => {
                if (Drupal.uscgov.isMobileMenuSystem()) navigateToParent(backButton);
            });
        });
    }
    ...
    function getActiveSubMenu() {
        ...
        if (tertiaryActiveSubmenu) activeSubmenu = tertiaryActiveSubmenu;
        else {
            if (secondaryActiveSubmenu) activeSubmenu = secondaryActiveSubmenu;
        }
        if (activeSubmenu) {
            const mainMenuHeight = getMainMenuHeight();
            if (mainMenuHeight) activeSubmenu.style.minHeight = mainMenuHeight + 'px';
        }
    ...
    function getMainMenuHeight() {
        return document.querySelector('.header__menu-wrapper') ? .scrollHeight;
    }
...
((Drupal, once) => {
    ...
    function init(menu) {
        ...
        menuButtons.forEach((button) => {
            button.closest('.primary-menu__menu-item--level-0').addEventListener('focusout', (e) => {
                if (!Drupal.uscgov.isMobileMenuSystem()) {
                    ...
                    if (!parentItem.contains(e.relatedTarget)) toggleVisibility(button, false);
                }
            }, true);
        ...
        document.addEventListener('click', (e) => {
            if (!Drupal.uscgov.isMobileMenuSystem())
                if (!menu.contains(e.target)) closeAllMenus(menuButtons);
        });
    }
    ...
    function toggleVisibility(button, toState) {
        ...
        if (toState === false && menuItem.contains(document.activeElement)) button.focus();
    }
...
((Drupal, once) => {
    function transitionToDesktopNavigation(navWrapper, navItem) {
        ...
        if (navWrapper.clientHeight > (navItem.clientHeight * 1.5)) document.body.classList.add('is-mobile-nav');
    }

    function checkIfDesktopNavigationWraps(entries) {
        const navItem = document.querySelector('.primary-menu__menu-item');
        if (!Drupal.uscgov.isMobileMenuSystem() && entries[0].contentRect.height > (navItem.clientHeight * 1.5)) {
    ...
    Drupal.behaviors.automaticMobileNav = {
        attach(context) {
            once('automatic-mobile-nav', '.header__navigation .primary-menu--level-0', context).forEach(init);
        }
    };
})(Drupal, once);;
(function($, Drupal) {
...
! function(e, t) {
    ...
    var $ = function t() {
        ...
        const he = S({}, [...L, ...v, ...x, ...k, ...I]);
        let ge = null;
        const Te = S({}, [...M, ...U, ...P, ...F]);
        let ye = Object.seal(l(null, {
                tagNameCheck: {
                    writable: !0,
                    configurable: !1,
                    enumerable: !0,
            ...
            Ue = {},
            Pe = null;
        const Fe = S({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
        let He = null;
        const ze = S({}, ["audio", "video", "img", "source", "image", "track"]);
        let Be = null;
        const We = S({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
        ...
        let qe = je,
            Xe = !1,
            Ke = null;
        const Ve = S({}, [Ge, Ye, je], d);
        let $e = null;
        const Ze = ["application/xhtml+xml", "text/html"];
        let Je = null,
            Qe = null;
        const et = r.createElement("form"),
            tt = function(e) {
            ...
            nt = function() {
                ...
                if (!Qe || Qe !== e) {
                    ...
                    }(W, c)), null !== J && "string" == typeof Q && (Q = J.createHTML(""));
                    i && i(e), Qe = e
                }
            },
            ot = S({}, ["mi", "mo", "mn", "ms", "mtext"]),
            rt = S({}, ["foreignobject", "desc", "title", "annotation-xml"]),
            it = S({}, ["title", "style", "font", "a", "script"]),
            at = S({}, [...v, ...x, ...C]),
            lt = S({}, [...k, ...O]),
            ct = function(e) {
                f(o.removed, {
            ...
            ut = function(e) {
                ...
                "application/xhtml+xml" === $e && qe === je && (e = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + e + "</body></html>");
                const o = J ? J.createHTML(e) : e;
                if (qe === je) try {
                    t = (new B).parseFromString(o, $e)
                } catch (e) {}
                if (!t || !t.documentElement) {
                    t = ee.createDocument(qe, "template", null);
                    try {
                        t.documentElement.innerHTML = Xe ? Q : o
                    } catch (e) {}
                }
                const i = t.body || t.documentElement;
                return e && n && i.insertBefore(r.createTextNode(n), i.childNodes[0] || null), qe === je ? oe.call(t, we ? "html" : "body")[0] : we ? t.documentElement : i
            },
            mt = function(e) {
                return te.call(e.ownerDocument || e, e, R.SHOW_ELEMENT | R.SHOW_COMMENT | R.SHOW_TEXT, null)
            },
            ft = function(e) {
            ...
            dt = function(e) {
                let t = null;
                if (pt("beforeSanitizeElements", e, null), (n = e) instanceof z && ("string" != typeof n.nodeName || "string" != typeof n.textContent || "function" != typeof n.removeChild || !(n.attributes instanceof H) || "function" != typeof n.removeAttribute || "function" != typeof n.setAttribute || "string" != typeof n.namespaceURI || "function" != typeof n.insertBefore || "function" != typeof n.hasChildNodes)) return ct(e), !0;
                var n;
                const r = Je(e.nodeName);
                if (pt("uponSanitizeElement", e, {
                        tagName: r,
                        allowedTags: de
                    }), e.hasChildNodes() && !ft(e.firstElementChild) && A(/<[/\w]/g, e.innerHTML) && A(/<[/\w]/g, e.textContent)) return ct(e), !0;
                if (!de[r] || Ee[r]) {
                    if (!Ee[r] && gt(r)) {
                        if (ye.tagNameCheck instanceof RegExp && A(ye.tagNameCheck, r)) return !1;
                ...
                return e instanceof N && ! function(e) {
                    let t = Z(e);
                    t && t.tagName || (t = {
                        namespaceURI: qe,
                        tagName: "template"
                ...
                }(e) ? (ct(e), !0) : "noscript" !== r && "noembed" !== r && "noframes" !== r || !A(/<\/no(script|embed|frames)/i, e.innerHTML) ? (Re && 3 === e.nodeType && (t = e.textContent, u([ae, le, ce], (e => {
                    t = g(t, e, " ")
                })), e.textContent !== t && (f(o.removed, {
                    element: e.cloneNode()
                }), e.textContent = t)), pt("afterSanitizeElements", e, null), !1) : (ct(e), !0)
            },
            ht = function(e, t, n) {
                if (ke && ("id" === t || "name" === t) && (n in r || n in et)) return !1;
                if (be && !Ae[t] && A(se, t));
                else if (_e && A(ue, t));
                else if (!ge[t] || Ae[t]) {
                    if (!(gt(e) && (ye.tagNameCheck instanceof RegExp && A(ye.tagNameCheck, e) || ye.tagNameCheck instanceof Function && ye.tagNameCheck(e)) && (ye.attributeNameCheck instanceof RegExp && A(ye.attributeNameCheck, t) || ye.attributeNameCheck instanceof Function && ye.attributeNameCheck(t)) || "is" === t && ye.allowCustomizedBuiltInElements && (ye.tagNameCheck instanceof RegExp && A(ye.tagNameCheck, n) || ye.tagNameCheck instanceof Function && ye.tagNameCheck(n)))) return !1
                } else if (Be[t]);
                else if (A(pe, g(n, fe, "")));
                else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== T(n, "data:") || !He[e]) {
                    if (Ne && !A(me, g(n, fe, "")));
                    else if (n) return !1
                } else;
                return !0
            ...
            Tt = function(e) {
                ...
                for (; r--;) {
                    const i = t[r],
                        ...
                        s = Je(a);
                    let f = "value" === a ? c : y(c);
                    if (n.attrName = s, n.attrValue = f, n.keepAttr = !0, n.forceKeepAttr = void 0, pt("uponSanitizeAttribute", e, n), f = n.attrValue, n.forceKeepAttr) continue;
                    if (st(a, e), !n.keepAttr) continue;
                    if (!Se && A(/\/>/i, f)) {
                        st(a, e);
                        continue
                    }
                    ...
                    const p = Je(e.nodeName);
                    if (ht(p, s, f)) {
                        if (!Oe || "id" !== s && "name" !== s || (st(a, e), f = "user-content-" + f), J && "object" == typeof W && "function" == typeof W.getAttributeType)
                            if (l);
            ...
            yt = function e(t) {
                let n = null;
                const o = mt(t);
                for (pt("beforeSanitizeShadowDOM", t, null); n = o.nextNode();) pt("uponSanitizeShadowNode", n, null), dt(n) || (n.content instanceof s && e(n.content), Tt(n));
        ...
        return o.sanitize = function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                i = null,
                l = null;
            if (Xe = !e, Xe && (e = "\x3c!--\x3e"), "string" != typeof e && !ft(e)) {
            ...
            if (De || nt(t), o.removed = [], "string" == typeof e && (Me = !1), Me) {
                if (e.nodeName) {
                    const t = Je(e.nodeName);
                    if (!de[t] || Ee[t]) throw _("root node is forbidden and cannot be sanitized in-place")
                }
            } else if (e instanceof b) n = ut("\x3c!----\x3e"), r = n.ownerDocument.importNode(e, !0), 1 === r.nodeType && "BODY" === r.nodeName || "HTML" === r.nodeName ? n = r : n.appendChild(r);
            else {
                if (!ve && !Re && !we && -1 === e.indexOf("<")) return J && Ce ? J.createHTML(e) : e;
                if (n = ut(e), !n) return ve ? null : Ce ? Q : ""
            }
            n && Le && ct(n.firstChild);
            const c = mt(Me ? e : n);
            for (; i = c.nextNode();) dt(i) || (i.content instanceof s && yt(i.content), Tt(i));
            if (Me) return e;
            if (ve) {
                if (xe)
                    for (l = ne.call(n.ownerDocument); n.firstChild;) l.appendChild(n.firstChild);
                else l = n;
                return (ge.shadowroot || ge.shadowrootmode) && (l = re.call(a, l, !0)), l
            }
            let m = we ? n.outerHTML : n.innerHTML;
            return we && de["!doctype"] && n.ownerDocument && n.ownerDocument.doctype && n.ownerDocument.doctype.name && A(X, n.ownerDocument.doctype.name) && (m = "<!DOCTYPE " + n.ownerDocument.doctype.name + ">\n" + m), Re && u([ae, le, ce], (e => {
                m = g(m, e, " ")
            })), J && Ce ? J.createHTML(m) : m
        }, o.setConfig = function() {
            nt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}), De = !0
...
(function($, Drupal, drupalSettings, once, DOMPurify) {
    'use strict';
    if (typeof DOMPurify !== 'undefined') DOMPurify.addHook('uponSanitizeElement', function(node, data) {
    ...
    function sourceData(request, response) {
        ...
        function sourceCallbackHandler(data) {
            ...
            if (key) data = data.slice(0, autocomplete.options.forms[key].maxSuggestions);
            if (key)
                if (data.length) {
    ...
    function selectHandler(event, ui) {
        ...
        if (ui.item.value.search(',') > 0) terms.push('"' + ui.item.value + '"');
        ...
        if (key && autocomplete.options.forms[key].autoRedirect && ui.item.link) {
            ...
            if (key && autocomplete.options.forms[key].autoSubmit && ui.item.value) {
                $(this).val(ui.item.value);
                const form = $(this).closest('form');
                const submit = $('[type="submit"]', form);
                if (submit.length === 1) submit.click();
                else form.submit();
            }
        }
        return false;
    ...
    function renderMenu(ul, items) {
        ...
        $.each(items, function(index, item) {
            if ('group' in item) {
                ...
                if (item.group.group_id === 'more_results' || item.group.group_id === 'no_results') ul.append(currentGroup);
                else content.append(currentGroup);
            }
    ...
    function renderItem(ul, item) {
        ...
        if (!item.fields) item.fields = [item.label];
        var helper = document.createElement('textarea');
        innerHTML = '<div class="ui-autocomplete-fields ' + first + '">';
        $.each(item.fields, function(key, value) {
            helper.innerHTML = value;
            let output = value;
            if (typeof DOMPurify !== 'undefined') output = DOMPurify.sanitize(helper.value, {
                ADD_TAGS: ['script']
            });
            else {
    ...
    function resizeMenu() {
        ...
        ul.css({
            "maxHeight": (window.innerHeight - parent.offsetHeight - parent.getBoundingClientRect().top) + 'px'
        });
    }
    ...
    function replaceInObject(stash, needle, replacement) {
        ...
        $.each(stash, function(index, value) {
            if ($.type(value) === 'string') result[index] = value.replace(regex, input);
...
(function($, Drupal, cookies) {
    ...
    Drupal.behaviors.googleTranslatorDisclaimer = {
        attach: function(context, settings) {
            ...
            var config = settings.googleTranslatorDisclaimer || {},
                ...
                swap = function() {
                    ...
                    var translateGadgetObserver = new MutationObserver((mutations, obs) => {
                        ...
                        if (displayMode == "SIMPLE") var gadget = document.querySelector('.goog-te-gadget-simple a');
                        else var gadget = document.getElementsByClassName('goog-te-combo')[0];
                        if (gadget) {
            ...
            if (disclaimerLink.length && (!checkCookie || typeof cookies.get('googtrans') != 'undefined')) swap();
            else $(disclaimerLink).click(function(event) {
                if (config.disclaimer && config.disclaimer.trim().length > 0) {
...
(function(Drupal, drupalSettings, once) {
    ...
    const buildAlertElement = (alert) => {
        ...
        if (alert.dismissible) {
            ...
            for (let i = 0; i < dismissButtons.length; i++) dismissButtons[i].addEventListener('click', () => dismissAlert(alert));
        }
        ...
        fetchAlerts().then((alerts) => {
            ...
            alerts.forEach((alert) => {
                ...
                roots.forEach((root) => {
                    ...
                    if ((dismissed || !showOnThisPage) && existingAlertElement) removeAlert(existingAlertElement);
                });
            });
        });
    };
    ...
    const proxyPushState = () => {
        if (supportsHistoryPushState()) window.history.pushState = new Proxy(window.history.pushState, {
            apply(target, thisArg, argArray) {
                triggerHistoryEvent(thisArg, argArray);
                return target.apply(thisArg, argArray);
            }
        });
        if (supportsHistoryReplaceState()) window.history.replaceState = new Proxy(window.history.replaceState, {
            apply(target, thisArg, argArray) {
                triggerHistoryEvent(thisArg, argArray);
                return target.apply(thisArg, argArray);
            }
        ...
        attach: (context) => {
            once('sitewide_alerts_init', 'html', context).forEach(() => {
                ...
                if (drupalSettings.sitewideAlert.automaticRefresh === true) {
                    ...
                    if (!drupalSettings.sitewideAlert.automaticRefresh) clearInterval(interval);
                }
            });
        }
    };
...
(function(window) {
    ...
    function getRoute() {
        ...
        else if (path.includes('find')) return 'find';
        else {
    ...
    function gtag(label, category, arg1) {
        ...
        if (typeof window.gtagEvent !== 'undefined') {
            ...
            if (['fcf_court_website', 'fcf_court_ecf', 'fcf_court_ejuror', 'fcf_court_jury_info', 'fcf_court_search_name'].includes(label)) dataLayer.push({
                'event': label,
                'fcf_page': category,
                'fcf_court_name': arg1
            });
            else if (label === 'fcf_court_phone') dataLayer.push({
                'event': label,
                'fcf_page': category,
                'phone_number': arg1,
                'contact_type': 'phone'
            });
            else if (label === 'fcf_court_directions') dataLayer.push({
                'event': label,
                'fcf_page': category,
                'location_address': arg1
            });
            else if (label === 'fcf_search_location') dataLayer.push({
                'event': label,
                'fcf_page': category,
                'fcf_location_searched': arg1
            });
            else if (label === 'fcf_search_name') dataLayer.push({
                'event': label,
                'fcf_page': category,
                'fcf_court_name': arg1
            });
            else if (label === 'fcf_location_click') dataLayer.push({
                'event': label,
                'fcf_page': 'fcf_search_results',
                'fcf_court_name': arg1
            });
            else if (['fcf_results_filter_selected', 'fcf_results_filter_removed', 'fcf_results_filter_unchecked'].includes(label)) dataLayer.push({
                'event': label,
                'fcf_page': 'fcf_search_results',
                'fcf_filter': arg1
            });
            else if (label === 'fcf_results_select_all_filters') dataLayer.push({
                'event': label,
                'fcf_page': 'fcf_search_results',
                'fcf_filter_category': arg1
            });
            else if (label === 'fcf_results_page_number') dataLayer.push({
                'event': label,
                'fcf_page': 'fcf_search_results',
                'page_number': arg1
            });
            else if (label === 'fcf_results_shown') dataLayer.push({
                'event': label,
                'fcf_page': 'fcf_search_results',
                'results_shown': arg1
            });
            else if (label === 'fcf_results_reset_filters') dataLayer.push({
                'event': label,
                'fcf_page': 'fcf_search_results'
            });
            else dataLayer.push({
...
(function($, Drupal, drupalSettings, once) {
    Drupal.behaviors.googleAnalyticsEvents = {
        attach: function(context, settings) {
            ...
            $(once('fcf-useful-links', '.court-finder-court__links-list', context)).on('click', 'a', function(event) {
                const parentDivClass = $(this).closest('div').attr('class');
                let eventLabel = '';
                if (parentDivClass === 'court-finder-court-page-link') eventLabel = 'fcf_court_website';
                else if (parentDivClass === 'court-finder-court-ecf-link') eventLabel = 'fcf_court_ecf';
                else if (parentDivClass === 'court-finder-court-ejuror-link') eventLabel = 'fcf_court_ejuror';
                else {
                    if (parentDivClass === 'court-finder-court-jury-info-link') eventLabel = 'fcf_court_jury_info';
                }
                let eventValue = '';
            ...
            $(once('fcf-scroll-top', 'a.footer__back-to-top', context)).on('click', function(event) {
                if (drupalSettings.path.currentPath == "federal-court-finder/find") window.gtagEvent('fcf_scroll_top', 'fcf_search_results');
            });
            ...
            $(once('fcf-results-page-number', paginationSelector, context)).on('click', function(event) {
                ...
                if ($(this).hasClass('usa-pagination__next-page')) window.gtagEvent('fcf_results_next_page', 'fcf_search_results');
                else if ($(this).hasClass('usa-pagination__previous-page')) window.gtagEvent('fcf_results_previous_page', 'fcf_search_results');
                else {
                    if (page !== null) window.gtagEvent('fcf_results_page_number', 'fcf_search_results', page);
                }
            });
        }
    };
